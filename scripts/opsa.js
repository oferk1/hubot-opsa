...
(function() {
  var AnomaliesAPI, OpsaAPI, createJar, generateJar, getSessionId, hostName, lastTime, loginOpsa, okToContinue, ongoing, opsaHomeUrl, password, request, requestp, scan, user;
  ...
  loginOpsa = function(res1, loginCallback) {
    var invokeAPI, loginForm, seqUrl, xsrfUrl;
    if (!okToContinue()) {
      return;
    }
    ...
    return robot.respond(/display anomalies for host: (.*)/i, function(res) {
      ...
      loginCallback = function(xsrfToken, sessionId) {
        ...
        apiCallback = function(body) {
          var colIdx, colNames, collectionId, collections, columnIdx, obj, output, resultObjectIdx, row, rowIdx, table, tableIdx;
          colNames = new Array();
