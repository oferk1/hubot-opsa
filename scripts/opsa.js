...
(function() {
    var createJar, createMessage, displayAnomalies, displayHosts, getNewSessionIdRequestParams, getSecurityRequestParams, getSessionId, getXSRFRequestParams, hostName, ongoing, password, request, requestp, scan, semaphore, updateSemaphore, user;
    ...
    displayAnomalies = function (res1) {
        ...
        requestp(opsaHomeUrl).then((function (res, data) {
            ...
            requestp(secReq.url, secReq.headers, secReq.method, secReq.jar, secReq.form).then((function (res) {
                ...
                return requestp(newIdReq.url, newIdReq.headers, newIdReq.method, newIdReq.jar).then((function (res) {
                    var xsrfReq;
