...
(function() {
    var createMessage, displayAnomalies, displayHosts, hostName, password, request, requestp, scan, user;
  ...
  displayHosts = function(res) {
    ...
    displayAnomalies = function (res1) {
        ...
        requestp(opsaHomeUrl).then((function (res, data) {
            var cookie, firstCookie, headers, jSessionId, jar, securityCheckUrl;
            ...
            jar.setCookie(cookie, securityCheckUrl, function (error, cookie) {
                var a;
                return a = 5;
            });
            headers = {
            ...
            requestp(securityCheckUrl, headers).then((function (res, data) {
                var a;
                return a = 3;
            }));
        }), function (err) {
