...
(function () {
  var AnomHandler, OpsaSession, Properties, createJar, generateJar, getLabels, getLinkToHost, getOneHourAgoTS, getOpsaUri, getRequestedAnomaliyType, getRequestedHost, getSessionId, handleAnomRes, lastTime, now, okToContinue, ongoing, progressCallback, request, requestp;
  ...
  module.exports = function (robot) {
    return robot.respond(/display anomalies for (.*):?:\s*(.*)/i, function (userRes) {
      var sess;
