...
(function () {
  var AnomHandler, OpsaSession, Properties, createJar, generateJar, getLabels, getLinkToHost, getOneHourAgoTS, getOpsaUri, getRequestedAnomaliyType, getRequestedHost, getSessionId, handleAnomRes, now, progressCallback, registeredListeners, request, requestp;
  ...
  module.exports = function (robot) {
    ...
    return robot.respond(exp, function (userRes) {
      var sess;
