...
(function () {
  var AnomAPI, OpsaSessionHandler, Properties, RegistrationHandler, createJar, deepClone, generateJar, getLabels, getLinkToHost, getMetricesText, getNoDataText, getOneHourAgoTS, getOpsaUri, getRequestedAnomaliyType, getRequestedHost, getSessionId, handleNoData, hubotRouter, now, pleaseWaitMsg, progressCallback, request, requestp;
        ...
        return requestp({
          ...
          return requestp({
            ...
            return new Promise(function (resolve, reject) {
              return resolve({
                xsrfToken: res.body,
                jSessionId: localSessionData.sId
              });
            });
          });
        }));
  ...
  OpsaSessionHandler.prototype.getSessId = function () {
    return this.sData.sId;
  };
  ...
  module.exports = function (robot) {
    ...
    invokeAnomaliesAPI = function (userRes) {
      ...
      return opsaSess.login().then((function (res) {
        var anomAPI;
