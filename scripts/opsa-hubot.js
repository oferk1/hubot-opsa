...
(function () {
  var AnomAPI, OpsaSessionHandler, Properties, RegistrationHandler, createJar, generateJar, getLabels, getLinkToHost, getOneHourAgoTS, getOpsaUri, getRequestedAnomaliyType, getRequestedHost, getSessionId, hubotRouter, now, pleaseWaitMsg, progressCallback, registeredListeners, replyWithMetrics, request, requestp;
  ...
  replyWithMetrics = function (anomAPI, anomRes, userRes) {
    ...
    invokeAnomaliesAPI = function (userRes) {
      ...
      return opsaSessHandler.login().then((function (res) {
        ...
        return anomAPI.requestPrimaryData(userRes).then((function (anomRes) {
          return replyWithMetrics(anomAPI, anomRes, userRes);
        }));
      }));
    };
